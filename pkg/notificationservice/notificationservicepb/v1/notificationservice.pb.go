...
const file_pkg_notificationservice_notificationservicepb_v1_notificationservice_proto_rawDesc = "" +
	"\n" +
	"Jpkg/notificationservice/notificationservicepb/v1/notificationservice.proto\x12\x18mtch.notificationservice\"%\n" +
	"\rNotifyRequest\x12\x14\n" +
	"\x05email\x18\x01 \x01(\tR\x05email\"\x10\n" +
	"\x0eNotifyResponse2v\n" +
	"\x13NotificationService\x12_\n" +
	"\n" +
	"NotifyUser\x12'.mtch.notificationservice.NotifyRequest\x1a(.mtch.notificationservice.NotifyResponseBcZagithub.com/Arclight-V/mtch/pkg/notificationservice/notificationservicepb/v1;notificationservicepbb\x06proto3"
...
var file_pkg_notificationservice_notificationservicepb_v1_notificationservice_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pkg_notificationservice_notificationservicepb_v1_notificationservice_proto_goTypes = []any{
	(*NotifyRequest)(nil),  // 0: mtch.notificationservice.NotifyRequest
	(*NotifyResponse)(nil), // 1: mtch.notificationservice.NotifyResponse
}
var file_pkg_notificationservice_notificationservicepb_v1_notificationservice_proto_depIdxs = []int32{
	0, // 0: mtch.notificationservice.NotificationService.NotifyUser:input_type -> mtch.notificationservice.NotifyRequest
	1, // 1: mtch.notificationservice.NotificationService.NotifyUser:output_type -> mtch.notificationservice.NotifyResponse
