...
const (
	NotificationService_NotifyUser_FullMethodName = "/mtch.notificationservice.NotificationService/NotifyUser"
)
...
type NotificationServiceClient interface {
	NotifyUser(ctx context.Context, in *NotifyRequest, opts ...grpc.CallOption) (*NotifyResponse, error)
}
...
func (c *notificationServiceClient) NotifyUser(ctx context.Context, in *NotifyRequest, opts ...grpc.CallOption) (*NotifyResponse, error) {
...
type NotificationServiceServer interface {
	NotifyUser(context.Context, *NotifyRequest) (*NotifyResponse, error)
...
func (UnimplementedNotificationServiceServer) NotifyUser(context.Context, *NotifyRequest) (*NotifyResponse, error) {
...
func _NotificationService_NotifyUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NotificationServiceServer).NotifyUser(ctx, req.(*NotifyRequest))
	}
