...
func (mr *MockPasswordHasherMockRecorder) Compare(hash, plain interface{}) *gomock.Call {
...
func (mr *MockPasswordHasherMockRecorder) Hash(plain interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
